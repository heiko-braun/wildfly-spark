 ...
 * @author Heiko Braun
 */
class ContextAdd extends AbstractAddStepHandler {

    public final static ContextAdd INSTANCE = new ContextAdd();
    public static final ServiceName SERVICE_NAME = ServiceName.JBOSS.append("spark");
    ...
    protected void populateModel(ModelNode operation, ModelNode model) throws OperationFailedException {
        for (AttributeDefinition def : ContextDefinition.ATTRIBUTES) {
    ...
    static void installRuntimeServices(OperationContext context, PathAddress address, ModelNode fullModel, ServiceVerificationHandler verificationHandler, List<ServiceController<?>> controllers) throws OperationFailedException {
        ...
        SparkService service = new SparkService(clusterName);

        ServiceController<SparkService> controller = context.getServiceTarget()
