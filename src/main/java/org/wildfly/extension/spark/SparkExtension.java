 ...
 * @author Heiko Braun
 */
public class SparkExtension implements Extension {

    /**
     * The name space used for the {@code substystem} element
     */
    public static final String NAMESPACE = "urn:wildfly:spark:1.0";

    /**
     * The name of our subsystem within the model.
     */
    public static final String SUBSYSTEM_NAME = "spark";
    ...
    static StandardResourceDescriptionResolver getResourceDescriptionResolver(final String... keyPrefix) {
        ...
        return new StandardResourceDescriptionResolver(prefix.toString(), RESOURCE_NAME, SparkExtension.class.getClassLoader(), true, false);
    }
